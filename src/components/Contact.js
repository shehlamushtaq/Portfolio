  ...
  return (
    <>
      <Grid
        container
        spacing={3}
        style={{ marginTop: 60, display: "inline-flex" }}
      >
        <Grid
          item
          xs={5}
        ...
        <Grid item xs={6} style={{ backgroundColor: "#fff", marginRight: 20 }}>
          <label>Email = {formik.values.email}</label>
          <br />
          <label>Your Password = {formik.values.password}</label>
          <br />
          <br />

          <label>Email ={email2} </label>
          <br />
          <label>Your Password ={password2} </label>
          <br />
        </Grid>
      </Grid>
    </>
